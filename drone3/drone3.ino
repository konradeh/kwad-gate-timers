// ============================================================
//  DRONE 3  --  flash this sketch to the drone 3 beacon board
// ------------------------------------------------------------
//  Generated from drone1/drone1.ino - the ONLY difference is DRONE_ID.
//  If you change anything else here, mirror it back to drone1/.
// ============================================================
#include <WiFi.h>
#include <esp_now.h>
#include <esp_wifi.h>
